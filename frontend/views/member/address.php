...
<body>
	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="address_hd">
				...
				<dl>
					<dt><?=$add->id?>.&nbsp;<?=$add->name?> &nbsp; <?=$add->area?> &nbsp; <?=$add->address?> &nbsp; <?=$add->tel?> </dt>
					<dd>
						<a href="">修改</a>
						<a href="">删除</a>
						<a href="">设为默认地址</a>
				...
				<form action="" name="address_form" method="post">
						<ul>
							<li id="name">
								...
								<p style="color: red; padding-left: 6em"></p>
							</li>
							<li id="area">
								...
								<select id="areas" name="Address[areas]">
									<option>请选择区县</option>
								</select>
							</li>
							<li id="address">
	...
	<!-- 底部版权 end -->
		<script type="text/javascript">
			...
			$(function(){
				//页面加载完毕就获取省份列表
				var url = '/address/db.php';
				var args = 'pid=0';
				$.getJSON(url,args,function(data){
					//将省级数据放入province中
					$(data).each(function(i,v){
						var html = '<option value="'+v.name+'" id="'+v.id+'" >'+v.name+'</option>'
