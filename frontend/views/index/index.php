				...
				<div class="cat_bd">
					...
					<div class="cat item1">
						...
						<div class="cat_detail">
							<?php  $tows = \frontend\models\GoodsCategory::find()->where(['=','parent_id',$model->id])->all() ?>
							<?php foreach($tows as $tow):?>
							<dl class="dl_1st">
								<dt><a href="list?id=<?= $tow->id ?>"><?= $tow->name ?></a></dt>
								<dd>
									<?php  $thirds = \frontend\models\GoodsCategory::find()->where(['=','parent_id',$tow->id])->all() ?>
									<?php foreach($thirds as $third): ?>
									<a href="list?id=<?= $third->id ?>"><?= $third->name ?></a>
									<?php endforeach; ?>
								</dd>
							</dl>
							<?php endforeach; ?>
