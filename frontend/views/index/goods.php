		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="http://admin.yiishop.com<?= $picture->path ?>"></a>
								</li>
								<?php endforeach;  ?>
							</ul>
						</div>
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?= \yii\helpers\Url::to(['index/add-cart']) ?>" method="get" class="choose">
						<ul>
